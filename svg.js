...
(function() {
	...
	var svgs = Array.prototype.slice.call( document.querySelectorAll( 'svg' ) ),
		...
		current_frame = 0,
		total_frames = 650, /* define que a quantidade de frames total, será igual a 1k, mas apenas para controlar a velocidade da animacao, ja que gosto dela lenta */
		path = new Array(),
		length = new Array(),
		handle = 0;
	...
	function draw() {
		...
		/* o logo que desenhei no Illustrator possui apenas 270 frames de animacao (aprox) */
		if (progress > 0.28) {
